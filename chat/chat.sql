...
drop table if exists chat_room_onlines;
...
(
   ...
   account_id           int not null comment '群主id(关联sys_account表)这里考虑到群可以转让转让后群主也相应会转让',
   name                 varchar(32) not null comment '群名称',
   intro                varchar(256) not null comment '群简介',
...
alter table chat_room comment '聊天室';

/*==============================================================*/
/* Table: chat_room_join                                        */
/*==============================================================*/
create table chat_room_join
(
   id                   int not null comment 'id',
   classify             int not null comment '聊天室分类(同学、亲友、聚会)',
   ctime                datetime not null comment '创建时间',
   creater              varchar(16) not null comment '创建人',
   creater_id           int not null comment '创建人ID',
   etime                datetime comment '修改时间',
...
alter table chat_room_join comment '用户加入的聊天室列表';

/*==============================================================*/
/* Table: chat_room_onlines                                     */
/*==============================================================*/
create table chat_room_onlines
(
   id                   int not null comment '主键id',
   chat_room_id         int not null comment '聊天室id',
   account_id           int not null comment '用户id(关联sys_account表)',
   online_status        int not null comment '在线状态',
   token                varchar(32) not null comment '每进入一次都会生成一个token',
   ctime                datetime not null comment '创建时间',
   creater              varchar(16) not null comment '创建人',
   creater_id           int not null comment '创建人ID',
   comments             varchar(128) comment '备注',
...
alter table chat_room_onlines comment '聊天室在线列表，实时更新.';
...
(
   id                   int not null comment '主键id',
   chat_room_id         int not null comment '聊天室id(关联chat_room表)',
   account_id           int not null comment '账号id(关联sys_account表)',
   msg_body             varchar(1024) not null comment '消息内容',
   msg_type             int not null comment '消息类型',
   receive_time         datetime not null comment '服务器接收消息的时间',
   ctime                datetime not null comment '创建时间',
   creater              varchar(16) not null comment '创建人',
   creater_id           int not null comment '创建人ID',
   comments             varchar(128) comment '备注',
...
alter table chat_room_record comment '聊天室聊天记录';
...
(
   ...
   head_icon            varchar(64) comment '头像路径',
...
(
   id                   int not null comment 'id',
   account_id           int not null comment 'account_id',
   source_account_id    int not null comment '发起者的id(关联sys_account表)',
   target_account_id    varchar(128) not null comment '目标用户的id(关联sys_account表)',
   status               int not null comment '状态(0:已发送，1.已拒绝，2.已同意，3.已拉黑，4.已删除)',
   ctime                datetime not null comment '创建时间',
   creater              varchar(16) not null comment '创建人',
   creater_id           int not null comment '创建人ID',
   etime                datetime comment '修改时间',
...
alter table sys_user_friend comment '好友列表';
